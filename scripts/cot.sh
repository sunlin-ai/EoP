...
prompt_base=utils/prompt/cot/cot_base_aqua.txt
prompt_hint=utils/prompt/cot/cot_PHP_aqua.txt
...
prompt_base=utils/prompt/cot/cot_base_gsm8k.txt
prompt_hint=utils/prompt/cot/cot_PHP_gsm8k.txt
